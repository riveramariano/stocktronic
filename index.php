    ...
    <nav class=" navbar navbar-expand-md navbar-dark fixed-top applebg">
        ...
        <div class="collapse navbar-collapse" id="collapse_target">
            <ul class="navbar-nav list-inline mx-auto justify-content-center">
                <a class="navbar-brand mb-2 mr-5" href="#!">
                    <img src="images/isotipo.svg" width="20" height="20" />
                </a>
                <li class="nav-item mt-1 mr-5">
                    <a class="nav-link" href="pages/componentes.php">Componente</a>
                </li>
                <li class="nav-item mt-1 mr-5">
                    <a class="nav-link" href="#">Herramientas</a>
                </li>
                <li class="nav-item mt-1 mr-5">
                    <a class="nav-link" href="#">Impresoras 3D</a>
                </li>
                <li class="nav-item mt-1 mr-5">
                    <a class="nav-link" href="#">Cortadores Láser</a>
                </li>
                <li class="nav-item mt-1 mr-5">
                    <a class="nav-link" href="#">Raspberry Pi</a>
                </li>
                <li class="nav-item mt-1 mr-5">
